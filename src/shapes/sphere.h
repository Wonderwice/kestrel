...
public:
   ...
   */
  Sphere(Point3 center, float radius, const Material *material)
      : Shape(material), center(center), radius(radius) {compute_bounds();}
  ...
  virtual void rotate(float rotate_degree, const Vec3& offset) override;
};
